...
class TrackWebsiteViewNews extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'track:news';
     ...
     * @var string
     */
    protected $description = 'Store total news views by a session_id into the tracking summary table';
