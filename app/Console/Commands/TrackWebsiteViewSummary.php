...
class TrackWebsiteViewSummary extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'track:summary';
     ...
     * @var string
     */
    protected $description = 'Store total page views by a session_id into the tracking summary table';
